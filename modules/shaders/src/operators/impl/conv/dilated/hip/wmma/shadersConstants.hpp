...
namespace mlss::conv::dilated::hip::wmma::fp16
{
    ...
    constexpr std::array<std::uint32_t, 7> gemm2d_32x32x64NN_F16_F16_CONSTANTS   = { sizeof(std::uint16_t), 32, 32, 64, 64, 1, 1 };
    constexpr std::array<std::uint32_t, 7> gemm2d_64x32x32NN_F16_F16_CONSTANTS   = { sizeof(std::uint16_t), 64, 32, 32, 64, 1, 1 };
    constexpr std::array<std::uint32_t, 7> gemm2d_64x64x64NN_F16_F16_CONSTANTS   = { sizeof(std::uint16_t), 64, 64, 64, 128, 1, 1 };
    constexpr std::array<std::uint32_t, 7> gemm2d_128x64x32NN_F16_F16_CONSTANTS  = { sizeof(std::uint16_t), 128, 64, 32, 128, 1, 1 };
    constexpr std::array<std::uint32_t, 7> gemm2d_256x32x32NN_F16_F16_CONSTANTS  = { sizeof(std::uint16_t), 256, 32, 32, 128, 1, 1 };
    constexpr std::array<std::uint32_t, 7> gemm2d_128x128x32NN_F16_F16_CONSTANTS = { sizeof(std::uint16_t), 128, 128, 32, 256, 1, 1 };
