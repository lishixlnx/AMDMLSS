...
namespace mlss::shaders::gqa::ck::wmma::fp16
{
    ...
    const std::array<MLSSarg, 11> unpacked_double_pointer_ARGS_CONSTANTS = { {
    ...
    const std::array<MLSSarg, 27> unpacked_with_strides_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "Q"},
        {1, MLSS_FLOAT16, true, 2, true, true, false, "K"},
        {2, MLSS_FLOAT16, true, 2, true, true, false, "V"},
        {3, MLSS_FLOAT16, true, 2, false, false, true, "output"},
    ...
    const std::array<MLSSarg, 10> packed_qk_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "QK"},      // Packed Q and K
    ...
    const std::array<MLSSarg, 22> packed_qk_with_strides_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "QK"},      // Packed Q and K
        {1, MLSS_FLOAT16, true, 2, true, true, false, "V"},
        {2, MLSS_FLOAT16, true, 2, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 10> packed_kv_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 22> packed_kv_with_strides_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "Q"},
        {1, MLSS_FLOAT16, true, 2, true, true, false, "KV"},      // Packed K and V
        {2, MLSS_FLOAT16, true, 2, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 8> packed_qkv_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "QKV"},     // Packed Q, K, and V
    ...
    const std::array<MLSSarg, 16> packed_qkv_with_strides_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "QKV"},     // Packed Q, K, and V
        {1, MLSS_FLOAT16, true, 2, false, false, true, "output"},
        {2, MLSS_INT32, false, 0, true, true, false, "batch_size"},
        {3, MLSS_INT32, false, 0, true, true, false, "sequence_length"},
    ...
    const std::array<MLSSarg, 11> unpacked_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 27> unpacked_with_strides_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "Q"},
        {1, MLSS_FLOAT16, true, 1, true, true, false, "K"},
        {2, MLSS_FLOAT16, true, 1, true, true, false, "V"},
        {3, MLSS_FLOAT16, true, 1, false, false, true, "output"},
    ...
    const std::array<MLSSarg, 10> packed_qk_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "QK"},
    ...
    const std::array<MLSSarg, 22> packed_qk_with_strides_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "QK"},
        {1, MLSS_FLOAT16, true, 1, true, true, false, "V"},
        {2, MLSS_FLOAT16, true, 1, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 10> packed_kv_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 22> packed_kv_with_strides_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "Q"},
        {1, MLSS_FLOAT16, true, 1, true, true, false, "KV"},
        {2, MLSS_FLOAT16, true, 1, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 8> packed_qkv_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "QKV"},
    ...
    const std::array<MLSSarg, 16> packed_qkv_with_strides_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 1, true, true, false, "QKV"},
        {1, MLSS_FLOAT16, true, 1, false, false, true, "output"},
        {2, MLSS_INT32, false, 0, true, true, false, "batch_size"},
        {3, MLSS_INT32, false, 0, true, true, false, "sequence_length"},
    ...
    const std::array<MLSSarg, 11> unpacked_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 27> unpacked_with_strides_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "Q"},
        {1, MLSS_VOID, true, 2, true, true, false, "K"},
        {2, MLSS_VOID, true, 2, true, true, false, "V"},
        {3, MLSS_VOID, true, 2, false, false, true, "output"},
    ...
    const std::array<MLSSarg, 10> packed_qk_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "QK"},
    ...
    const std::array<MLSSarg, 22> packed_qk_with_strides_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "QK"},
        {1, MLSS_VOID, true, 2, true, true, false, "V"},
        {2, MLSS_VOID, true, 2, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 10> packed_kv_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 22> packed_kv_with_strides_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "Q"},
        {1, MLSS_VOID, true, 2, true, true, false, "KV"},
        {2, MLSS_VOID, true, 2, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 8> packed_qkv_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "QKV"},
    ...
    const std::array<MLSSarg, 16> packed_qkv_with_strides_void_double_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 2, true, true, false, "QKV"},
        {1, MLSS_VOID, true, 2, false, false, true, "output"},
        {2, MLSS_INT32, false, 0, true, true, false, "batch_size"},
        {3, MLSS_INT32, false, 0, true, true, false, "sequence_length"},
    ...
    const std::array<MLSSarg, 11> unpacked_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 27> unpacked_with_strides_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "Q"},
        {1, MLSS_VOID, true, 1, true, true, false, "K"},
        {2, MLSS_VOID, true, 1, true, true, false, "V"},
        {3, MLSS_VOID, true, 1, false, false, true, "output"},
    ...
    const std::array<MLSSarg, 10> packed_qk_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "QK"},
    ...
    const std::array<MLSSarg, 22> packed_qk_with_strides_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "QK"},
        {1, MLSS_VOID, true, 1, true, true, false, "V"},
        {2, MLSS_VOID, true, 1, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 10> packed_kv_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 22> packed_kv_with_strides_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "Q"},
        {1, MLSS_VOID, true, 1, true, true, false, "KV"},
        {2, MLSS_VOID, true, 1, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 8> packed_qkv_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "QKV"},
    ...
    const std::array<MLSSarg, 16> packed_qkv_with_strides_void_single_pointer_ARGS_CONSTANTS = { {
        {0, MLSS_VOID, true, 1, true, true, false, "QKV"},
        {1, MLSS_VOID, true, 1, false, false, true, "output"},
        {2, MLSS_INT32, false, 0, true, true, false, "batch_size"},
        {3, MLSS_INT32, false, 0, true, true, false, "sequence_length"},
