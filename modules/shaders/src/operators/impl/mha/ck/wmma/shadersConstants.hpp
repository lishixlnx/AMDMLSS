...
namespace mlss::shaders::mha::ck::wmma::fp16
{
    ...
    const std::array<MLSSarg, 9> packed_qk_ARGS_CONSTANTS = { {
    ...
    const std::array<MLSSarg, 21> packed_qk_with_strides_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "QK"},      // Packed Q and K
        {1, MLSS_FLOAT16, true, 2, true, true, false, "V"},
        {2, MLSS_FLOAT16, true, 2, false, false, true, "output"},
        {3, MLSS_INT32, false, 0, true, true, false, "batch_size"},
    ...
    const std::array<MLSSarg, 26> unpacked_q_k_v_with_strides_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "Q"},
        {1, MLSS_FLOAT16, true, 2, true, true, false, "K"},
        {2, MLSS_FLOAT16, true, 2, true, true, false, "V"},
        {3, MLSS_FLOAT16, true, 2, false, false, true, "output"},
    ...
    const std::array<MLSSarg, 21> packed_q_kv_with_strides_ARGS_CONSTANTS = { {
        {0, MLSS_FLOAT16, true, 2, true, true, false, "Q"},
    ...
    const std::array<MLSSarg, 15> packed_qkv_with_strides_ARGS_CONSTANTS = { {
