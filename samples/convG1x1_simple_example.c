...
int main(int argc, char* argv[])
{
    ...
    printf("=== ConvG1x1 Simple Example ===\n");
    ...
    MLSSbool   hasBias = false;          // If there is a bias tensor.
    ...
    MLSSbool activation = false;
    MLSSuint32 precision = MLSS_FLOAT32;
    ...
    auto result = mlssGetCaps(context, &pStatuses, &nStatuses);
