...
int main(int argc, char* argv[])
{
    ...
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_BATCH, &batch_size));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_QSEQ, &q_sequence_length));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_KVSEQ, &kv_sequence_length));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_KDIM, &kvDim));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_VDIM, &kvDim));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_SIZEHEADS, &head_dim));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_PACKING, &packing));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_QHEADCOUNT, &q_head_num));
    CHECK_STATUS(mlssSetParameterByEnum(&context, opName, MLSS_ATTR_GQA_KVHEADCOUNT, &kv_head_num));
